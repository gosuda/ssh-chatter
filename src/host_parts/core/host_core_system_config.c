...
#define SSH_CHATTER_RSS_SYNC_ATTEMPTS 2U
#define SSH_CHATTER_RSS_SYNC_TRANSFER_TIMEOUT_MS 8000L
#define SSH_CHATTER_RSS_FAILURE_THRESHOLD 3U
#define SSH_CHATTER_RSS_FAILURE_WINDOW_SECONDS 600L
